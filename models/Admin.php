...
class Admin
{
 ...
 public function crearproveedor($proveedor,$contacto,$telefono, $direccion)
  ...
  public function Crearproducto($nombre_producto,$desc_producto,$precio_venta, $cantidad_max,$cantidad_min,$stock,$fecha_registro)
  { 
    $sql = "INSERT INTO `tbl_productos`(`nombre_producto`, `desc_producto`, `precio_venta`, `cantidad_max`,`cantidad_min`,`stock`,`fecha_registro`) 
    VALUES ('$nombre_producto','$desc_producto','$precio_venta','$cantidad_max','$cantidad_min','$stock','$fecha_registro')";
    $stmt = $this->db->query($sql);
    return $stmt;
  }
  ...
  public function EditarProducto($id,$nombre_producto,$desc_producto,$precio_venta)
  { 
