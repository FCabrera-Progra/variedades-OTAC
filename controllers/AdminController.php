...
public function reporteProducto()
     ...
     public function crearproducto()
    {
        if (isset($_POST['crear'])) {
            ...
            $Admin = new Admin();
            $auth = new Auth();
                $result = $Admin->Crearproducto($nombre_producto, $desc_producto, $precio_venta, $cantidad_max, $cantidad_min, $stock,$fecha_registro);
    ...
    public function Actualizarproducto()
    {
        ...
        if (isset($_POST['actualizar'])) {
            ...
            $result = $Admin->EditarProducto($id, $nombre_producto, $desc_producto, $precio_venta);
